...
INSERT  INTO `customer1` (`email`, `pwd`, `role`) VALUES ('happy@example.com', '{noop}shalini.techgatha@12345', 'read');
INSERT  INTO `customer1` (`email`, `pwd`, `role`) VALUES ('admin@example.com', '{{bcrypt}$2a$12$28hTdBcrUf7xzTwpPKvnLOlOcNqXaVsIu/A76pjE.//p7arHpRL1m', 'admin');
